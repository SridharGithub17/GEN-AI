...
def get_graph_in_streamlit(default_cypher,order):
    ...
    # Define specific positions for the nodes (all keys are now lowercase)
        ...
        "src1_data": (0, 0),              # Now at the bottom  
        "src2_data1": (2, 0),              # Now at the bottom
        "src2_data2": (4, 0),             # Now at the bottom
        ...
        "fin_acct_txns": (2, 5),          # Now at the top
           ...
           pos = {
        "src1_data": (3, 6),              # Now at the bottom  
        "src2_data1": (1,6),              # Now at the bottom
        "src2_data2": (2, 6),             # Now at the bottom
